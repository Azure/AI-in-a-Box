          ...
          actions: {
              ...
              actions: {
                ...
                RecognizeFileFunction: {
                  ...
                  inputs: {
                    ...
                    method: 'POST'
                    uri: 'https://${azureFunctionsAppName}.azurewebsites.net/api/RecognizeFile?code=${FunctionAppHostKey}'
                  }
                }
              }
              runAfter: {
            ...
            SplitFileFunction: {
              ...
              inputs: {
                ...
                method: 'POST'
                uri: 'https://${azureFunctionsAppName}.azurewebsites.net/api/SplitFile?code=${FunctionAppHostKey}'
              }
            }
          }
          runAfter: {
