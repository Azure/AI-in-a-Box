...
The recommendations that follow are based on lessons learned from rolling out a responsible AI practice across one of the organizations within Microsoft. As you review the recommendations, keep in mind they should be *adapted to fit your organization, circumstances, and product plans*.   The approach was grounded in principles, standards, practices, and tools that have been used internally for several years, including:  
...
A *Responsible AI impact assessment* is the process a product team follows to identy and assess the potential risks and harms of an AI system.  It is a new process, and some organizations may be reluctant to consider it, giving reasons such as:
...
Plan to evaluate your AI system on an ongoing basis: use cases change, system updates affect functionality, new technology is introduced, and data drifts.

## Strategies to help
The pace of AI is moving quickly and RAI-specific tools are needed to help advance the responsible design, development, and deployment of AI systems. The reality today is that the RAI tools landscape is evolving.  There are building blocks and recommendations but the overall landscape can be fragmented, making it difficult to establish and end-to-end workflow. Some challenges:
* There is no single tool that can holistically assess potential AI harms.
* Tools often do not map directly to a RAI principle or standard, such as *fairness* or *transparency*, making it difficult to select an approrpiate tool. 
...
#### Get started with RAI metrics 
  Measuring RAI involves both *technical attributes*, like accuracy and security, and *socio-technical attributes* such as fairness, representational harms, allocation harms, sand afety and reliability. A starter set of metrics could be platform, usage, and operational level metrics.  For instance: *resource consumption* (GPU, CPU, memory utilization, response times), *response/request tracking* (number of unique/active users, requests, prompts, token usage), and *operational metrics* (quota, capacity, latency, throttling). See [Monitoring Azure OpenAI Service](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/monitoring).

  Add a layer of metrics to measure the potential for RAI harms identified through the impact assessment process. Consider: number of input prompts blocked, number of responses blocked, number of jailbreak attempts, metrics related to quality of generated output such as groundedness, relevance, and similarity. 

  #### Tools to support RAI
  Tools to support an RAI practice for *GenAI* applications focus on model selection, prompt engineering, and model output of generated images, text, audio, or video. Recommendations include:
...
* Medium article: [Responsible AI in action, Part 1: Get started](https://medium.com/data-science-at-microsoft/responsible-ai-in-action-part-1-get-started-ee50bebbdff3?source=friends_link&sk=3a9ad40230116d9fc4c66fdf7ab56de2)
* Medium article: [Responsible AI in action, Part 2: Complete an impact assessment](https://medium.com/data-science-at-microsoft/responsible-ai-in-action-part-2-complete-an-impact-assessment-9b792409e8db?source=friends_link&sk=6e68eb938a2be1d776748cc55a89b663)
* Medium article: [Responsible AI in action, Part 3: Tools to help](https://medium.com/data-science-at-microsoft/responsible-ai-in-action-part-3-tools-to-help-969e45cac11b?source=friends_link&sk=69bfea1ae66e2b7272d58e28a49cafe4)
